...
export function LogoSymbol({ width = 64 }: LogoProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} viewBox="0 0 16 16">
...
export function LogoFull({ width = 256 }: LogoProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} viewBox="0 0 256 69.186">
      <path
